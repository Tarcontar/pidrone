...
static const uint32_t USART_BAUD = 500000;
static const rcc_periph_clken USART_RCC_PORT = RCC_GPIOA;
static const rcc_periph_clken USART_RCC_USART_PORT = RCC_USART1;
static const uint32_t USART_PORT = GPIOA;
static const uint32_t USART_TX = GPIO11;
static const uint32_t USART_RX = GPIO10;
...
static const rcc_periph_clken _MOTOR_1_RCC_PORT = RCC_GPIOB;
static const uint32_t _MOTOR_1_PORT = GPIOB;
static const uint32_t _MOTOR_1_PIN = GPIO6;
static const tim_oc_id _MOTOR_1_CHANNEL = TIM_OC1;

static const rcc_periph_clken _MOTOR_2_RCC_PORT = RCC_GPIOB;
static const uint32_t _MOTOR_2_PORT = GPIOB;
...
static const uint32_t _MOTOR_3_PIN = GPIO9;
...
static const uint32_t _MOTOR_4_PIN = GPIO8;
